...
class Widget extends Component {
  ...
  calculateLayout() {
    ...
    if (this.props.widgetHeight < 230 && this.props.aspectRatio < 2) {
      ...
      this.props.secondaryVizualisation !== "none" &&
  ...
  calculatePrimaryFontRef() {
    ...
    return baseFontSize + stepper;
  }

  calculatePrimaryFontSize() {
    return TypeSize(this.calculatePrimaryFontRef());
  }

  calculateLabelLayout() {
    let wide = this.props.aspectRatio >= 2;
    let floatedSecondaryViz =
  ...
  isLabelShown() {
    if (!this.props.labelOn) {
      ...
      this.props.widgetHeight < 470 &&
      this.calculateLayout() === "stacked" &&
      this.props.titleOn
    ) {
      return false;
    } else {
