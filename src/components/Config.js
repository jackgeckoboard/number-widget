...
class Config extends Component {
  ...
  onPrimaryNumberTextChange(event) {
    this.props.onPrimaryNumberTextChange(
      this.props.prefix,
      event.target.value,
      this.props.suffix
    );
  ...
  onSetTransformSize100() {
    this.props.onTransformSizeChange(0);
  }
  ...
  onSetTransformSize60() {
    this.props.onTransformSizeChange(-2);
  }
      ...
      <div className="w-30 fl bg-dark-gray vh-100 pa4 overflow-y-scroll">
        ...
        {this.props.secondaryVizualisation === "comparisonNumber" &&
          <div>
            ...
            />
            <label htmlFor="comparisonLabelCheckbox">
              Show label for comparison number
            </label>
            <br />
            <input
              className="br2 pa2 w-100 bn bg-mid-gray white"
        ...
        <div className="cf">
          <div className="w-50 fl pr3">
            <label htmlFor="width" className="f6 db mb2">
              Width
            </label>
            <input
              className="br2 pa2 w-100 bn bg-mid-gray white"
        ...
        <p className="f6 db mb2 mt4 ">Scale main number font size</p>
        <button
          className="mr2 pv2 ph3 br2 mb2 bn bg-moon-gray pointer bg-animate hover-bg-light-gray"
